...
object DataDummy {
    ...
    fun generateRemoteDummyListMovies(): ArrayList<MovieEntity> {
        val movieEntity = ArrayList<MovieEntity>()
        movieEntity.add(MovieEntity(508442,
            0,
            "Soul",
    ...
    fun generateRemoteDummyListTVShow(): ArrayList<MovieEntity> {
        val movieEntity = ArrayList<MovieEntity>()
        movieEntity.add(MovieEntity(85271,
            1,
            "WandaVision",
    ...
    fun generateRemoteDummyMovieDetail(movie_id: Int): DetailMovieEntity {
        val detailMovie1 = DetailMovieEntity()
        detailMovie1.id = 635302
        detailMovie1.title = "Demon Slayer: Infinity Train"
        detailMovie1.date = "2020-10-16"
    ...
    fun generateRemoteDummyError(): String {
        return "ERROR!"
    }
